  ...
  return (
    <div className="space-y-8 py-4" id="biblioteca-section">
      ...
      <div className="space-y-2">
        <span className="font-mono text-[10px] text-emerald-700 tracking-wider uppercase font-semibold">Base de Saberes</span>
        <h2 className="font-serif text-2xl sm:text-3xl font-bold text-stone-900">Biblioteca Agroecológica</h2>

...
export default function Layout() {
  ...
  return (
    ...
    >
      ...
      <main className="flex-grow w-[100%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <footer className="border-t border-stone-200 bg-stone-50 py-6" id="app-footer">
        <div className="mx-auto w-[100%] px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
